...
export const REFINE_SYSTEM = [
  ...
  'Decide: if the caregiver is asking a question or discussing, return type="reply" with a helpful answer.',
  'If the caregiver asks you to propose changes, improve exercises, fix issues, or says anything that calls',
  'for concrete modifications to the routine, return type="plan" with a ProposedChange list.',
